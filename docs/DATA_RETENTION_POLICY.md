...
| Durable outbound message content | outbound_message | 90 days after last update in terminal state | Redact recipient address, message body and provider message ID; retain idempotency/operational envelope | Preserves replay protection and usage linkage while removing sensitive delivery payload. |
