...
public class UniversalWhatsAppToolService extends WhatsAppToolService {
    ...
    public String buildInstructions(MessagingConversation conversation) {
        ...
        return super.buildInstructions(conversation)
                ...
                + "\nUna petición explícita de una NUEVA reserva o cita inicia siempre una operación nueva, aunque la conversación tenga una reserva anterior CONFIRMED. No reutilices operationId, confirmationToken, serviceId ni startAt de una reserva anterior para una nueva intención. Solo usa reschedule_booking cuando el cliente diga explícitamente que quiere cambiar, mover o reprogramar una reserva existente."
